...
\centering{%
  \hspace{-.3in}
  \subfloat[\label{fig:cross-side-normal}]{\includegraphics{drawings/cross-side-normal-labeled.ps}}
  \\
  \vspace{.5in}
  \hspace{-.3in}
  \subfloat[\label{fig:cross-side-advance}]{\includegraphics{drawings/cross-side-advance-labeled.ps}}
  \\
  \vspace{.5in}
  \hspace{-.3in}
  \subfloat[\label{fig:cross-side-retract}]{\includegraphics{drawings/cross-side-retract-labeled.ps}}
  \\
}
\addtocounter{figure}{1} %% Required for subfloats 
\setcounter{subfigure}{0} %% Required for subfloats
\label{pg:last} %% LAST PAGE REFERENCE, PUT THIS INSIDE OR AFTER LAST FIGURE
\end{sidewaysfigure}
